...
const BACKEND_URL = 'https://fn-sastri-graph-proxy1-cufvhzhsc6b0f0dq.brazilsouth-01.azurewebsites.net/api/DirectorySubscriptionsAdmin';
...
app.http('DirectorySubscriptionsAdmin', {
    ...
    handler: async (request, context) => {
        ...
        if (!backendResponse.ok) {
            ...
            return {
                ...
                headers: { 'Content-Type': 'application/json', ...require('./shared/cors').corsHeaders(request) },
                jsonBody: { ok: false, codigo: String(backendResponse.status), erro: errMsg }
            };
        }
