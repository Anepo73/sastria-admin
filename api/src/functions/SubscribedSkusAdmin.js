...
const BACKEND_URL = 'https://fn-sastri-graph-proxy1-cufvhzhsc6b0f0dq.brazilsouth-01.azurewebsites.net/api/SubscribedSkusAdmin';
...
app.http('SubscribedSkusAdmin', {
    ...
    handler: async (request, context) => {
        ...
        // Function key do backend via variável de ambiente
